...
::: {.column style="display:inline-block;width:27%;border-radius:1em;margin:1%;padding:1.5%;background-color:#f5f5f5"}
<figure>
    <img src="/figures/people/daniel.jpeg" alt="Asistente 3" style="object-fit: cover;width:5em;height:5em;border-radius: 50%;font-size:1em;">
    <figcaption>
...
::: {.column style="display:inline-block;width:27%;border-radius:1em;margin:1%;padding:1.5%;background-color:#f5f5f5"}
<figure>
    <img src="/figures/people/valeria.png" alt="Asistente 4" style="object-fit: cover;width:5em;height:5em;border-radius: 50%;font-size:1em;">
    <figcaption>
        <strong>Valeria Acevedo Fernández</strong><br/>
        Micología
    </figcaption>
</figure>
:::
