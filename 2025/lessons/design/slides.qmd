...
- Purpose: avoids systematic bias.  
- Ensures treatment effects are not confounded with hidden variables.  
- Can be complete or restricted (within blocks).  

**Example:** Randomly assign shading vs control to ponds, not just “first half shaded, second half control.”  
