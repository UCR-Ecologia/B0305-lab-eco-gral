...
title: "<font style='font-size:1em;'>Escribiendo Reportes Científicos con Quarto</font>"
...
- **Alternativa:** VS Code con extensión de Quarto
:::
...
<h1 style="margin-top: 0;">Título principal</h1>
<h2>Subtítulo</h2>  
<h3>Sub-subtítulo</h3>
...
```{r}
#| label: fig-logistico
#| fig-cap: "Crecimiento logístico de *Saccharomyces cerevisiae*"
#| fig-width: 5
#| fig-height: 3.5
#| echo: false
...
Como se observa en @fig-logistico, el crecimiento presenta una curva típica logística.
:::
...
```{r}
#| label: tbl-parametros
#| tbl-cap: "Parámetros del modelo logístico estimados"
#| echo: false
...
Los parámetros estimados (@tbl-parametros) muestran que la capacidad de carga es aproximadamente 987 células/mL.
:::
...
3. **En RStudio:**  
   ...
   - Renombrar `B305-report-template.qmd` → `mi-reporte.qmd` 
...
git init
git add .
git commit -m "Versión inicial del reporte"

# Después de cambios importantes
git add -A
git commit -m "Agregado análisis estadístico"
```
::: -->
