...
title: "<font style='font-size:1em;'> Introducción a R</font>"
...
## Instalación de RStudio {.smaller}
...
## Verificación de la instalación {.smaller}
...
## Configuración del curso {.smaller}
...
- **Descargar** el archivo `renv.lock` desde: [**https://ucr-ecologia.github.io/B0305-lab-eco-gral/renv.lock**](https://ucr-ecologia.github.io/B0305-lab-eco-gral/renv.lock)
...
## Ejercicio 3: Data frames y análisis {.smaller}
...
## Ejercicio 4: Visualización básica {.smaller}
...
## Ejercicio 5: Configuración del entorno {.smaller}
